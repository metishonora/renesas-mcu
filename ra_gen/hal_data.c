...
{ .baud_rate_prescaler = 3, .time_segment_1 = 11, .time_segment_2 = 4, .synchronization_jump_width = 4 };
#else
can_bit_timing_cfg_t g_can0_bit_timing_cfg =
{
...
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x7270e00,
  .duty_cycle_counts = 0x3938700, .source_div = (timer_source_div_t) 0, .channel = 3, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
/* Actual period: 0.199981689453125 seconds. Actual duty: 49.99236990691286%. */.period_counts = (uint32_t) 0x1999,
  .duty_cycle_counts = 0xccc, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback = AGT1_Interrupt,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
/* Actual period: 0.5 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x4000,
  .duty_cycle_counts = 0x2000, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = AGT0_Interrupt,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
